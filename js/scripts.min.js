...
/* harmony import */ var flickity_responsive__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flickity-responsive */ "./node_modules/flickity-responsive/dist/flickity-responsive.module.js");
...
/***/ "./node_modules/flickity-responsive/dist/flickity-responsive.module.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/flickity-responsive/dist/flickity-responsive.module.js ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FlickityExtend: () => (/* binding */ E),
/* harmony export */   FlickityResponsive: () => (/* binding */ F),
/* harmony export */   _attr: () => (/* binding */ M)
/* harmony export */ });
/**!
 ...
 */var e={d:(t,r)=>{for(var n in r)e.o(r,n)&&!e.o(t,n)&&Object.defineProperty(t,n,{enumerable:!0,get:r[n]})},o:(e,t)=>Object.prototype.hasOwnProperty.call(e,t)},t={};e.d(t,{YJ:()=>O,EC:()=>A,xO:()=>k});
/**!
 ...
 * @license MIT 2022
 */
var r={d:(e,t)=>{for(var n in t)r.o(t,n)&&!r.o(e,n)&&Object.defineProperty(e,n,{enumerable:!0,get:t[n]})},o:(e,t)=>Object.prototype.hasOwnProperty.call(e,t)},n={};function i(e,t=!0){const r=[...e];return t?r.sort(((e,t)=>e.breakpoint<t.breakpoint?1:-1)):r.sort(((e,t)=>e.breakpoint>t.breakpoint?1:-1)),r}function o(e,t=150){let r;return(...n)=>{clearTimeout(r),r=setTimeout((()=>{e.apply(this,n)}),t)}}r.d(n,{o:()=>s});class s{constructor(e){if(this.dev=!0===e.dev,this.object=e.object||void 0,this.object){if(this.onMatched=e.onMatched,this.onUpdate=e.onUpdate,window.addEventListener("resize",o((()=>{"function"==typeof this.onUpdate&&this.onUpdate(this.currentObject)}),this.debounce)),!this.object.responsive)return this.currentObject={type:"no-responsive",lastBreakpoint:void 0,breakpoint:-1,object:this.mergeObject(-1,this.object)},"function"==typeof this.onMatched&&this.onMatched(this.currentObject),this.dev&&console.warn("Property object must have responsive array."),!1;this.isInherit=void 0===e.isInherit||e.isInherit,this.debounce=e.debounce||100,this.currentObject={breakpoint:void 0,object:{}},this.object.responsive=i(this.object.responsive),this.match(),window.addEventListener("resize",o((()=>this.match()),this.debounce))}else console.error("Property object:{} must be provided.")}match(){let e=!1;for(let t=0;t<this.object.responsive.length;t++){const r=this.object.responsive[t];if(e=matchMedia(this.getQuery(t)).matches,e){this.currentObject.breakpoint!==r.breakpoint&&(this.currentObject={type:"responsive",lastBreakpoint:this.currentObject.breakpoint,breakpoint:r.breakpoint,object:this.mergeObject(r.breakpoint,r.settings)},"function"==typeof this.onMatched&&this.onMatched(this.currentObject));break}}e||-1===this.currentObject.breakpoint||(this.currentObject={type:"default",lastBreakpoint:this.currentObject.breakpoint,breakpoint:-1,object:this.mergeObject(-1,this.object)},"function"==typeof this.onMatched&&this.onMatched(this.currentObject))}getQuery(e){let t=`screen and (max-width:${this.object.responsive[e].breakpoint}px)`;const r=this.object.responsive[e+1];return r&&(t+=` and (min-width:${r.breakpoint+1}px)`),t}mergeObject(e,t){let r={...t};if(this.isInherit&&-1!==e){const t=i(this.object.responsive,!1);for(let n=0;n<t.length;n++)t[n].breakpoint>e&&(r={...t[n].settings,...r})}return r={...this.object,...r},delete r.responsive,r}}var c=n.o;function a(e){return"undefined"!=typeof jQuery&&e instanceof jQuery}function d(e){let t={};if(!function(e){try{return JSON.parse(e)&&!!e}catch(e){return!1}}(e))return t;t=JSON.parse(e);for(const[e,r]of Object.entries(t))"false"===r&&(t[e]=!1),"true"===r&&(t[e]=!0);return t}function l(e,t){if("string"==typeof e){let r=document;if(t)if(r=t,t.closest(`[${k.wrapper}]`))r=t.closest(`[${k.wrapper}]`);else{const e=t.closest(`div:has([${k.init}]), div:has(.flickity-enabled)`);if(e){1===e.querySelectorAll(`[${k.init}], .flickity-enabled`).length?r=e:console.warn(`Multiple Flickity instances found in ${e}. Using ${r} instead.`)}}return r.querySelectorAll(e)}let r=a(e)?e.get():e;return r instanceof NodeList||Array.isArray(r)||(r=[r]),r}function u(e,t){if(t.isInfinite)return;const r=e.options.customArrows.prevArrow.el,n=e.options.customArrows.nextArrow.el,i=function(e){const{selectedIndex:t,slides:r}=e;return 0===t?0:t===r.length-1?1:-1}(e),o=(e,t)=>{t?e.forEach((e=>e?.setAttribute("disabled","disabled"))):e.forEach((e=>e?.removeAttribute("disabled")))};0===i?(o(r,!0),o(n,!1)):1===i?(o(r,!1),o(n,!0)):(o(n,!1),o(r,!1))}function p(e,t){const r=!0===t.indicatorZeroPad;let n=l(t.indicatorTotal,e.element),i=l(t.indicatorCurrent,e.element);const o=e.slides.length;if(n&&n.length&&n.forEach((e=>e.innerText=r?h(o):o)),i&&i.length){let t=e.selectedIndex;i.forEach((e=>e.innerText=r?h(t+1):t+1)),e.on("change",(t=>{const n=e.selectedIndex+1;i.forEach((e=>e.innerText=r?h(n):n))}))}}function h(e=0){return e.toString().padStart(2,"0")}function f(e,t){if(!0!==t.forceMove)return;e.element.classList.add(t._class.isForceMove);let r=e.selectedSlide;e.on("change",(()=>{const t=e.selectedSlide,n=y(r,t);if(0===n)return;let i=b(e.slides,t,1===n);t.target===r.target&&(i+=n),r=e.selectedSlide,e.select(i)}))}const b=(e,t,r=!0)=>r?e.findLastIndex((e=>e.target===t.target)):e.findIndex((e=>e.target===t.target)),y=(e,t)=>t.x>e.x?1:t.x<e.x?-1:0;function v(e,t){let r=Flickity.data(e);const n=void 0!==r;n&&r.destroy(),t.destroy?n&&r.destroy():(r=new Flickity(e,t),t.wrapAround&&(r.options.wrapAround=g(r)),t.isInfinite=t.hasOwnProperty("wrapAround")&&r.options.wrapAround,function(e,t){const r={prevArrow:{func:()=>e.previous(),el:[]},nextArrow:{func:()=>e.next(),el:[]}};let n=!1;Object.entries(r).forEach((([i,o])=>{if(!t.hasOwnProperty(i))return;const s=t[i];if(!s)return;const c=l(s,e.element);c&&"object"==typeof c&&(Array.isArray(c)&&c.every((e=>void 0===e))||(c.forEach((e=>{e&&e.addEventListener("click",(()=>o.func()))})),r[i].el=c,e.element.classList.add(`has-custom-${i}`),n=!0))})),e.options.customArrows=r,e.options.hasCustomArrow=n,n&&(u(e,t),e.on("change",(()=>u(e,t))))}(r,t),p(r,t),f(r,t),r.resize())}function j(e,t){if(!0!==t.responsiveNavigation)return;const r=[];e.pageDots&&r.push(e.pageDots.holder),e.prevButton&&r.push(e.prevButton.element),e.nextButton&&r.push(e.nextButton.element),e.options.hasCustomArrow&&(r.push(...e.options.customArrows.prevArrow.el),r.push(...e.options.customArrows.nextArrow.el));const n=Math.round(e.slideableWidth)>Math.round(e.size.innerWidth);r.forEach((e=>{e&&"object"==typeof e&&(n?(e.classList.remove(t._class.isFreeze),e.style.display=""):(e.classList.add(t._class.isFreeze),e.style.display="none"))})),n?e.element.classList.remove(t._class.isCannotSlide):e.element.classList.add(t._class.isCannotSlide),e.options.draggable=n,e.updateDraggable()}function w(e,t,r){return"undefined"==typeof Flickity?(console.warn("Flickity is undefined!"),!1):(new c({object:t,onMatched:t=>v(e,{...r,...t.object}),onUpdate:t=>function(e,t){let r=Flickity.data(e);r&&(r.resize(),j(r,t),t.wrapAround&&(r.options.wrapAround=g(r)))}(e,{...r,...t.object})}),function(e,t){let r=Flickity.data(e);r&&(t.object?.wrapAround&&(t.object.wrapAround=g(r)),j(r,t),p(r,t),f(r,t),function(e,t){t.ariaHiddenFocus&&e.element.querySelectorAll(t.ariaHiddenFocusSelector).forEach((e=>{e.setAttribute("tabindex","-1"),e.classList.add("is-focus-disabled")}))}(r,t))}(e,{...r,...t}),!0)}function g(e){const t=e.cells.reduce(((e,t)=>e+t.size.width),0);return Math.round(e.size.width)<Math.round(t)}const k={init:"data-flickity-responsive",indicatorCurrent:"data-indicator-current",indicatorTotal:"data-indicator-total",prevArrow:"data-prev-arrow",nextArrow:"data-next-arrow",wrapper:"data-flickity-wrapper"},m={contain:!0,destroy:!1,prevArrow:`[${k.prevArrow}]`,nextArrow:`[${k.nextArrow}]`,responsiveNavigation:!0,indicatorZeroPad:!1,indicatorCurrent:`[${k.indicatorCurrent}]`,indicatorTotal:`[${k.indicatorTotal}]`,forceMove:!0,ariaHiddenFocusSelector:'[aria-hidden="true"] a, [aria-hidden="true"] button',ariaHiddenFocus:!0,_class:{isFreeze:"is-freeze",isForceMove:"is-force-move",isCannotSlide:"is-cannot-slide"}};class A{constructor(e,t){if(w(e,t,m))return this.flickity=Flickity.data(e),this.flickity}}var x;"undefined"!=typeof jQuery&&((x=jQuery).fn.flickityResponsive=function(e){x(this).get().forEach((t=>new A(t,e)))}),document.querySelectorAll(`[${k.init}]`).forEach((e=>{const t=d(e.getAttribute(k.init));new A(e,t)}));class O{constructor(e,t){new A(e,t)}}"undefined"!=typeof jQuery&&function(e){e.fn.flickityExtend=function(t){e(this).get().forEach((e=>new A(e,t)))}}(jQuery);var E=t.YJ,F=t.EC,M=t.xO;
